...
function _tabComplete(show) {
  ...
  complete = completer.call(this, completeOn);
  if (!complete)
    return;
...
module.exports = function (opts) {
  ...
  var config = rl._config = {};
  config.appendHelpGroup   = opts.appendHelpGroup;
  config.appendHelpDefault = opts.appendHelpDefault;
