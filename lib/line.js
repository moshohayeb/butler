...
(function () {
  ...
  function parse() {
    ...
    _.each(this.pipeline, function (component) {
      ...
      if (!rv) {
        this._errorMsg      = component._errorMsg;
        this._errorToken    = component._errorToken;
        this._errorLocation = this.context.line.lastIndexOf(this._errorToken);
        return false;
      }
  ...
  function Line(line, blueprint, config) {
    if (!(this instanceof Line)) {
      return new Line(line, blueprint, config);
    }

    // line should be a string
    try { line = line.toString() }
    catch (e) { line = '' }
